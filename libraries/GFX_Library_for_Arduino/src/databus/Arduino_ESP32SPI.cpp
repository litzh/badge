...
#if defined(ESP_ARDUINO_VERSION_MAJOR) && defined(ESP_ARDUINO_VERSION_MINOR) && defined(ESP_ARDUINO_VERSION_PATCH) && ((ESP_ARDUINO_VERSION_MAJOR > 3) || (ESP_ARDUINO_VERSION_MAJOR == 3 && ESP_ARDUINO_VERSION_MINOR > 3) || (ESP_ARDUINO_VERSION_MAJOR == 3 && ESP_ARDUINO_VERSION_MINOR == 3 && ESP_ARDUINO_VERSION_PATCH >= 3))
...
bool Arduino_ESP32SPI::begin(int32_t speed, int8_t dataMode)
{
  ...
  if (!_div)
  {
    _div = GFX_SPI_CLOCK_DIV(_spi, _speed);
  }
